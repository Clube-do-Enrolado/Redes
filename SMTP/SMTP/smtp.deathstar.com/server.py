...
# | TEMA: Protocolo SMTP                                                 |                  
# | TIPO: Servidor SMTP smtp.deathstar.com                               |
# |                                                                      |
# | ÚLTIMA MODIFICAÇÃO: 14/10/2020 04:42                                 |
# |                                                                      |
# ========================================================================
...
class CustomSMTPServer(smtpd.SMTPServer):
    ...
    def process_message(self, peer, mailfrom, rcpttos, data, mail_options=None, rcpt_options=None):
        ...
        for i in rcpttos:
            ...
            # deathstar.com para salvar a mensagem no servidor.
            if(i.find("@deathstar.com") > -1):
            ...
            # Se o domínio do destinatario for @jaku.com, o servidor de-
            # verá encaminhar o e-mail para outro endereço.
            elif(i.find("@jaku.com") > -1):

                # Tenta se conectar ao servidor deathstar.com
                try:
                    # Anúncia que está se conectando ao jaku.com para o
                    # servidor.
                    print("Contatando domínio jaku.com")
                ...
                # Trata a exceção caso não seja possível se conectar.
                    ...
                    print("Não foi possível se conectar ao jaku.com")
...
#        |
#        V                    {IP}    {Porta}
server = CustomSMTPServer(("127.0.0.1", 1030), None)

# Notifica que o servidor está em execução
print("Servidor smtp.deathstar.com em execucao")
